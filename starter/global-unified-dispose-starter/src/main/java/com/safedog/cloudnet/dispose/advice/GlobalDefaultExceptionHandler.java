...
import com.safedog.cloudnet.dispose.exception.category.BusinessException;
...
public class GlobalDefaultExceptionHandler {
    ...
    public ResultBody handlerNoHandlerFoundException(NoHandlerFoundException e) throws Throwable {
        errorDispose(e);
        outPutErrorWarn(NoHandlerFoundException.class, CommonErrorCode.NOT_FOUND, e);
        return ResultBody.ofFail(CommonErrorCode.NOT_FOUND);
    }
    ...
    public ResultBody handlerHttpRequestMethodNotSupportedException(
        ...
        return ResultBody.ofFail(CommonErrorCode.METHOD_NOT_ALLOWED);
    }
    ...
    public ResultBody handlerHttpMediaTypeNotSupportedException(
        ...
        return ResultBody.ofFail(CommonErrorCode.UNSUPPORTED_MEDIA_TYPE);
    }
    ...
    public ResultBody handlerException(Exception e) throws Throwable {
        errorDispose(e);
     ...
     * 二次深度检查错误类型
     */
    private ResultBody ifDepthExceptionType(Throwable throwable) throws Throwable {
        ...
        return ResultBody.ofFail(CommonErrorCode.EXCEPTION);
    }
    ...
    public ResultBody handlerFeignException(FeignException e) throws Throwable {
        errorDispose(e);
        outPutError(FeignException.class, CommonErrorCode.RPC_ERROR, e);
        return ResultBody.ofFail(CommonErrorCode.RPC_ERROR);
    }
    ...
    public ResultBody handlerClientException(ClientException e) throws Throwable {
        errorDispose(e);
    ...
    public ResultBody handlerBusinessException(BusinessException e) throws Throwable {
        errorDispose(e);
        outPutError(BusinessException.class, CommonErrorCode.BUSINESS_ERROR, e);
        return ResultBody.ofFail(e.getCode(), e.getMessage());
    }
    ...
    public ResultBody handleHttpMessageNotReadableException(HttpMessageNotReadableException e) throws Throwable {
        errorDispose(e);
        ...
        return ResultBody.ofFail(CommonErrorCode.PARAM_ERROR.getCode(), msg);
    }
    ...
    public ResultBody handleConstraintViolationException(ConstraintViolationException e) throws Throwable {
        errorDispose(e);
        String smg = "";
        ...
        if (constraintViolations.isEmpty()) {
            ...
            ResultBody.ofFail(CommonErrorCode.BUSINESS_ERROR.getCode(), "");
        }

        return ResultBody.ofFail(CommonErrorCode.PARAM_ERROR.getCode(), smg);
    }
    ...
    public ResultBody handleMethodArgumentNotValidException(MethodArgumentNotValidException e) throws Throwable {
        errorDispose(e);
    ...
    public ResultBody handleBindException(BindException e) throws Throwable {
        errorDispose(e);
    ...
    private ResultBody getBindResultDTO(BindingResult bindingResult) {
